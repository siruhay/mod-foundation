...
class FoundationCommunitymap extends Model
{
    use Filterable;
    use HasMeta;
    use HasPageSetup;
     ...
     * @var string
     */
    protected $table = 'foundation_communitymaps';
     ...
     * @var array
     */
    protected $roles = ['foundation-communitymap'];
    ...
    public static function storeRecord(Request $request)
    {
        ...
        try {
            ...
            return new CommunitymapResource($model);
        } catch (\Exception $e) {
